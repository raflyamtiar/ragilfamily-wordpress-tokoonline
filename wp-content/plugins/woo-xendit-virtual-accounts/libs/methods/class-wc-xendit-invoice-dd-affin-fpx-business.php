...
class WC_Xendit_DD_Affin_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_AFFIN_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_affin_fpx_business';
        ...
        $this->default_title = 'Affin Bank B2B';
        ...
        $this->method_title = __('Xendit Affin Bank B2B', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-affin-fpx-business-settings.php');
    }
