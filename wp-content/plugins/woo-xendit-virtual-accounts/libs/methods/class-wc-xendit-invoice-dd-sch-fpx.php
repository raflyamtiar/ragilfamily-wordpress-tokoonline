...
class WC_Xendit_DD_SCH_FPX extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 30000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'DD_SCH_FPX';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_sch_fpx';
        ...
        $this->default_title = 'Standard Chartered';
        ...
        $this->method_title = __('Xendit Standard Chartered', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-sch-fpx-settings.php');
    }
