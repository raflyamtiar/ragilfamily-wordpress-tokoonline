...
class WC_Xendit_QRPh extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 50000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'QRPH';
    ...
    public function __construct()
    {
        ...
        $this->method_title = __('Xendit QRPh', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-qrph-settings.php');
    }
