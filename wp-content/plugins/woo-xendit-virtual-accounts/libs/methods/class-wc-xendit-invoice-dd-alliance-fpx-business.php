...
class WC_Xendit_DD_Alliance_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_ALLIANCE_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_alliance_fpx_business';
        ...
        $this->default_title = 'Alliance Bank (Business)';
        ...
        $this->method_title = __('Xendit Alliance Bank (Business)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-alliance-fpx-business-settings.php');
    }
