...
class WC_Xendit_DD_Mayb2e_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_MAYB2E_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_mayb2e_fpx_business';
        ...
        $this->default_title = 'Maybank2E (Business)';
        ...
        $this->method_title = __('Xendit Maybank2E (Business)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-mayb2e-fpx-business-settings.php');
    }
