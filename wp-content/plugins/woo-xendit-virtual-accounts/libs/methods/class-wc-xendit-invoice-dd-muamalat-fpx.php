...
class WC_Xendit_DD_Muamalat_FPX extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 30000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'DD_MUAMALAT_FPX';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_muamalat_fpx';
        ...
        $this->default_title = 'Bank Muamalat';
        ...
        $this->method_title = __('Xendit Bank Muamalat', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-muamalat-fpx-settings.php');
    }
