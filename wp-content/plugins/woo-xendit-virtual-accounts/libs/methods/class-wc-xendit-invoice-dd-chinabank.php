...
class WC_Xendit_DD_Chinabank extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 20000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'DD_CHINABANK';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_chinabank';
        ...
        $this->default_title = 'Direct Debit Chinabank';
        ...
        $this->method_title = __('Xendit DD Chinabank', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-chinabank-settings.php');
    }
