...
class WC_Xendit_Jeniuspay extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 10000000;
    const DEFAULT_MINIMUM_AMOUNT = 1000;

    const XENDIT_METHOD_CODE = 'JENIUSPAY';

    public function __construct()
    {
        parent::__construct();

        $this->id           = 'xendit_jeniuspay';
        ...
        $this->method_title = __('Xendit JeniusPay', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-jeniuspay-settings.php');
    }
