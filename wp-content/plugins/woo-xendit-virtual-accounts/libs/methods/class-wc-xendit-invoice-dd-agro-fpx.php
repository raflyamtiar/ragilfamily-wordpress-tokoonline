...
class WC_Xendit_DD_Agro_FPX extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 30000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'DD_AGRO_FPX';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_agro_fpx';
        ...
        $this->method_title = __('Xendit AGRONet', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-agro-fpx-settings.php');
    }
