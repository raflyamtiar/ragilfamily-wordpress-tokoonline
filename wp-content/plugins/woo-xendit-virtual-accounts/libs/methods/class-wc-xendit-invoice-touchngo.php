...
class WC_Xendit_Touchngo extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 20000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'TOUCHNGO';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_touchngo';
        ...
        $this->method_title = __('Xendit Touch \'N Go', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-touchngo-settings.php');
    }
