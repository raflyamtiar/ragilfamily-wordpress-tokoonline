...
class WC_Xendit_DD_RHB_FPX extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 30000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'DD_RHB_FPX';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_rhb_fpx';
        ...
        $this->method_title = __('Xendit RHB Bank', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-rhb-fpx-settings.php');
    }
