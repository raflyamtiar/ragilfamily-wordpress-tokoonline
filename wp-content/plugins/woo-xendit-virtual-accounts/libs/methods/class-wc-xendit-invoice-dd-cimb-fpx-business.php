...
class WC_Xendit_DD_CIMB_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_CIMB_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_cimb_fpx_business';
        ...
        $this->default_title = 'CIMB (Business)';
        ...
        $this->method_title = __('Xendit CIMB (Business)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-cimb-fpx-business-settings.php');
    }
