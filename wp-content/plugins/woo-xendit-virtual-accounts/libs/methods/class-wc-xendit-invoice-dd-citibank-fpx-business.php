...
class WC_Xendit_DD_Citibank_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_CITIBANK_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_citibank_fpx_business';
        ...
        $this->default_title = 'Citibank Corporate Banking';
        ...
        $this->method_title = __('Xendit Citibank Corporate Banking', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-citibank-fpx-business-settings.php');
    }
