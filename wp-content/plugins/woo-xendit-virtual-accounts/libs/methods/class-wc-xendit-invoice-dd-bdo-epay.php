...
class WC_Xendit_DD_BDO_Epay extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 50000;
    const DEFAULT_MINIMUM_AMOUNT = 1;

    const XENDIT_METHOD_CODE = 'DD_BDO_EPAY';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_bdo_epay';
        ...
        $this->default_title = 'Direct Debit BDO Epay';
        ...
        $this->method_title = __('Xendit DD BDO Epay', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-bdo-epay-settings.php');
    }
