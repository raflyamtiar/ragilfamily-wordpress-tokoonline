...
class WC_Xendit_DD_Deutsche_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_DEUTSCHE_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_deutsche_fpx_business';
        ...
        $this->default_title = 'Deutsche Bank';
        ...
        $this->method_title = __('Xendit Deutsche Bank', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-deutsche-fpx-business-settings.php');
    }
