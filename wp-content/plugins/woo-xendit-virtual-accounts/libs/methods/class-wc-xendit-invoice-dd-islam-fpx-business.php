...
class WC_Xendit_DD_Islam_FPX_Business extends WC_Xendit_Invoice
{
    const DEFAULT_MAXIMUM_AMOUNT = 1000000;
    const DEFAULT_MINIMUM_AMOUNT = 2;

    const XENDIT_METHOD_CODE = 'DD_ISLAM_FPX_BUSINESS';

    public function __construct()
    {
        parent::__construct();

        $this->id = 'xendit_dd_islam_fpx_business';
        ...
        $this->default_title = 'Bank Islam (Business)';
        ...
        $this->method_title = __('Xendit Bank Islam (Business)', 'woocommerce-xendit');
    ...
    {
        $this->form_fields = require(WC_XENDIT_PG_PLUGIN_PATH . '/libs/forms/wc-xendit-invoice-dd-islam-fpx-business-settings.php');
    }
