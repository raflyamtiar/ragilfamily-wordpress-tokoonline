        ...
        if (e instanceof Date) {
          for (n = t.length, a = 0; n > a; a++)
            "S" !== (i = t.charAt(a)) &&
              ...
              (a > 0 && "\\" === t.charAt(a - 1)
                ? (u += i)
                : ((o = s.parseFormat(i, e)), a !== n - 1 && s.intParts.test(i) && "S" === t.charAt(a + 1) && ((r = parseInt(o) || 0), (o += s.dateSettings.ordinal(r))), (u += o)));
          return u;
        }
        return "";
      },
            ...
            return (
              C.startDate
                ...
                : (t = C.value || (a && a.val && a.val() ? a.val() : ""))
                  ? ((t = A.strToDateTime(t)),
                    C.yearOffset && (t = new Date(t.getFullYear() - C.yearOffset, t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds())))
                  ...
                  (u = setTimeout(function () {
                    ...
                    for (
                      ...
                      (T = []),
                        ...
                        C.allowDateRe &&
                          "[object RegExp]" === Object.prototype.toString.call(C.allowDateRe) &&
                          (C.allowDateRe.test(r.formatDate(p, C.formatDate)) || T.push("xdsoft_disabled")),
